...
class RETHREAD_API IThreadProxy : public TSharedFromThis<IThreadProxy>
{
public:
	IThreadProxy();
	...
	FORCEINLINE FThreadHandle GetThreadHandle() { return ReThreadHandle; }
protected:
...
private:
	...
	TSharedPtr<FReThreadHandle> ReThreadHandle;
};