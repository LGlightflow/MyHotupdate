...
FReOSSManage *FReOSSManage::ReOSS = nullptr;
...
FReOSSManage * FReOSSManage::Get()
{
	if (!ReOSS)
	{
		ReOSS = new FReOSSManage();
...
void FReOSSManage::Destroy()
{
	if (ReOSS)
	{
		//Save cofig
		ReOSS->GetOSS().SaveAccounts();
...
//		{
//			std::shared_ptr<FReOSSRateLimiter> Recv = std::make_shared<FReOSSRateLimiter>();
...
//		{
//			std::shared_ptr<FReOSSRateLimiter> Send = std::make_shared<FReOSSRateLimiter>();
...
FString FReOSSManage::FOSS::GetEndpoint()
{
	return UTF8_TO_TCHAR(Endpoint.c_str());
}

void FReOSSManage::FOSS::InitAccounts(const FString &InAccessKeyId, const FString &InAccessKeySecret, const FString &InEndpoint)
{
	AccessKeyId = TCHAR_TO_UTF8(*InAccessKeyId);
	AccessKeySecret = TCHAR_TO_UTF8(*InAccessKeySecret);
	Endpoint = TCHAR_TO_UTF8(*InEndpoint);

	OSS_SUCCESS_MSG("Account infomation update succeeded through InitAccounts(const FString &InAccessKeyId, const FString &InAccessKeySecret, const FString &InEndpoint);->ReOSSManange.cpp [230]\n")
}

const TCHAR* Section = TEXT("OSSAccounts");
void FReOSSManage::FOSS::InitLocalAccounts()
{
...
void FReOSSManage::FOSS::SaveAccounts()
{
	OSS_REGISTRATION_CONFIGURATION
...
void FReOSSManage::FOSS::InitConf(const FClientConfiguration &InConf)
{
	Conf = InConf;
...
bool FReOSSManage::FOSS::DoesBucketExist(const FString &InBucketName)
{
	return GetBucketAcl(InBucketName) != EAcl::NONE;
}

bool FReOSSManage::FOSS::GetImageObject_Internal(const FString &InBucketName, const FString &InObjectName, const FString &InFileNametoSave, const FString &Command)
{
...
bool FReOSSManage::FOSS::GetImageObject(const FString &InBucketName, const FString &InObjectName, const FString &InFileNametoSave, const FString &Command)
{
...
void FReOSSManage::FOSS::init_options(void *inoptions)
{
...
ANSICHAR* FReOSSManage::FOSS::multibyte_to_utf8(const ANSICHAR * ch, ANSICHAR *str, int32 size)
{
	if (!ch || !str || size <= 0)
	{
		return NULL;
...
bool FReOSSManage::FOSS::CreateBucket(const FString &InBucketName, EOSSStorageType OSSStorageType , EAcl Acl)
{
	STRING_TO_AOS_STRING_T(bucket, InBucketName);
	CREATE_CONFIGURATION_AND_STORAGE;
...
bool FReOSSManage::FOSS::ListBuckets(TArray<FString> &InBucketName)
{
	CREATE_CONFIGURATION_AND_STORAGE;
...
bool FReOSSManage::FOSS::GetBucketsInfo(const FString &InBucketName, FBucketInfo &InBucketInfo)
{
	STRING_TO_AOS_STRING_T(bucket,InBucketName);
	CREATE_CONFIGURATION_AND_STORAGE;
...
//int64 FReOSSManage::FOSS::GetBucketsStorageCapacity(const FString &InBucketName)
//{
...
FString FReOSSManage::FOSS::GetBucketLocation(const FString &InBucketName)
{
	FString OssLocation;
...
bool FReOSSManage::FOSS::DeleteBucket(const FString &InBucketName)
{
	int32 Number = 1000;
...
bool FReOSSManage::FOSS::SetBucketAcl(const FString &InBucketName, EAcl BucketAcl)
{
	STRING_TO_AOS_STRING_T(bucket, InBucketName);
	CREATE_CONFIGURATION_AND_STORAGE;
...
EAcl FReOSSManage::FOSS::GetBucketAcl(const FString InBucketName)
{
	EAcl Acl = EAcl::NONE;
...
//bool FReOSSManage::FOSS::SetBucketRequestPayment(const FString &InBucketName, ERequestPayerType InRequestPayer)
//{
...
//}
//
//ERequestPayerType FReOSSManage::FOSS::GetBucketRequestPayment(const FString &InBucketName)
//{
//	ANSICHAR* bucket_name = TCHAR_TO_UTF8(*InBucketName);
//
//	FAuxiliaryTools  AuxiliaryTools;
...
bool FReOSSManage::FOSS::SetBucketReferer(const FString &InBucketName, const TArray<FString> &URLReferer, bool bAllowEmptyRefere /*= false*/)
{
	CREATE_CONFIGURATION_AND_STORAGE;
	STRING_TO_AOS_STRING_T(bucket, InBucketName);
...
bool FReOSSManage::FOSS::GetBucketReferer(const FString &InBucketName, TArray<FString> &BucketReferers)
{
	CREATE_CONFIGURATION_AND_STORAGE;
	STRING_TO_AOS_STRING_T(bucket, InBucketName);
...
bool FReOSSManage::FOSS::DeleteBucketReferer(const FString &InBucketName, bool bAllowEmptyRefere /*= true*/)
{
	CREATE_CONFIGURATION_AND_STORAGE;
	STRING_TO_AOS_STRING_T(bucket, InBucketName);
...
bool FReOSSManage::FOSS::GetObjectMeta(const FString &InBucketName, const FString &InObjectName, FOSSObjectMeta &OSSObjectInfo)
{	
	CREATE_CONFIGURATION_AND_STORAGE;
...
EAcl FReOSSManage::FOSS::GetObjectAcl(const FString &InBucketName, const FString &InObjectName)
{
	CREATE_CONFIGURATION_AND_STORAGE;
...
bool FReOSSManage::FOSS::SetObjectAcl(const FString &InBucketName, const FString &InObjectName, EAcl InAcl)
{
	CREATE_CONFIGURATION_AND_STORAGE;
...
bool FReOSSManage::FOSS::DoesObjectExist(const FString &InBucketName, const FString &InObjectName)
{
	return GetObjectAcl(InBucketName, InObjectName) != EAcl::NONE;
}

bool FReOSSManage::FOSS::ListObjectsByPrefix(const FString &InBucketName, const FString &Prefix, TArray<FOSSObjectInfo> &ObjectName, int32 MaxNumber)
{
	return ListObjects_Internal(InBucketName, "/", Prefix,  ObjectName, MaxNumber);
}

bool FReOSSManage::FOSS::RecursiveListObjectsByPrefix(const FString &InBucketName, const FString &Prefix, TArray<FOSSObjectInfo> &ObjectName, int32 MaxNumber /*= 100*/)
{
	return ListObjects_Internal(InBucketName,"" ,Prefix, ObjectName, MaxNumber);
}

bool FReOSSManage::FOSS::ListObjects(const FString &InBucketName, TArray<FOSSObjectInfo> &ObjectName, int32 MaxNumber /*= 100*/)
{
	return ListObjects_Internal(InBucketName,"","",ObjectName, MaxNumber);
}

//bool FReOSSManage::FOSS::SetObjectStorageType(const FString &InBucketName, const FString &InObjectName, EOSSStorageType OSSStorageType)
//{
//	if (OSSStorageType == EOSSStorageType::NONE)
//	{
//		OSSStorageType = EOSSStorageType::STANDARD;
...
//}
//
//EOSSStorageType FReOSSManage::FOSS::GetObjectStorageType(const FString &InBucketName, const FString &InObjectName)
//{
...
bool FReOSSManage::FOSS::CreateSymlink(const FString &InBucketName, const FString &InObjectName, const FString &InLinkObjectName)
{
	CREATE_CONFIGURATION_AND_STORAGE;
...
FString FReOSSManage::FOSS::GetSymlink(const FString &InBucketName, const FString &InLinkName)
{
	CREATE_CONFIGURATION_AND_STORAGE;
...
bool FReOSSManage::FOSS::GeneratePresignedUrl(FString &URL, const FString &InBucketName, const FString &InObjectName)
{
	CREATE_CONFIGURATION_AND_STORAGE;
...
bool FReOSSManage::FOSS::GetObjectToMemory(
...
bool FReOSSManage::FOSS::GetObjectToMemoryByURL(
	const FString& URL,
	FString &ContextString,
	FRange Range /*= FRange()*/,
	ProgressCallback InProgressCallback /*= nullptr*/,
...
bool FReOSSManage::FOSS::GetObjectToLocal(
	const FString &InBucketName, 
	const FString &InObjectName,
...
bool FReOSSManage::FOSS::GetObjectToLocalByURL(
	const FString& URL,
	const FString& InLocalPaths,
	FRange Range /*= FRange()*/,
	ProgressCallback InProgressCallback /*= nullptr*/,
...
#include <thread>
bool FReOSSManage::FOSS::ResumableDownloadObject(
	const FString &InBucketName,
	const FString &InObjectName,
...
bool FReOSSManage::FOSS::CopyObject(
...
//
//bool FReOSSManage::FOSS::CopyPart(FString &UploadID, const FString &InSourceBucketName, const FString &InSourceObjectName, const FString &InCopyBucketName, const FString &InCopyObjectName)
//{
//}

bool FReOSSManage::FOSS::DeleteObject(const FString &InBucketName, const FString &InObjectName)
{
	CREATE_CONFIGURATION_AND_STORAGE
...
bool FReOSSManage::FOSS::DeleteObjectByPrefix(const FString &InBucketName, const FString &InPrefix)
{
	CREATE_CONFIGURATION_AND_STORAGE
...
bool FReOSSManage::FOSS::DeleteObjects(const FString &InBucketName, const TArray<FString> &InObjectName)
{
	CREATE_CONFIGURATION_AND_STORAGE
...
bool FReOSSManage::FOSS::ListMultipartUploads(const FString &InBucketName, TArray<FMultipartPartsUploadsInfo> &MultipartPartsInfo, int32 MaxParts /*= 1000*/)
{
...
void FReOSSManage::FOSS::AsyncPutObject(
	const FString &InBucketName, 
	const FString &InLocalPaths, 
...
void FReOSSManage::FOSS::AsyncPutObjectByURL(
	const FString& URL, 
	const FString& InLocalPaths,
...
void FReOSSManage::FOSS::AsyncPutObjectByMemory(
	const FString &InBucketName, 
	const FString &InObjectName /*= FString()*/,
	const FString &Data, 
	ProgressCallback InProgressCallback /*= nullptr*/, 
...
void FReOSSManage::FOSS::AsyncPutObjectMemoryByURL(const FString& URL, const FString &Data, const TMap<FString, FString> &OSSMeta /*= TMap<FString, FString>()*/, ProgressCallback InProgressCallback /*= nullptr*/)
{
	AsyncTask(ENamedThreads::AnyBackgroundThreadNormalTask,
...
void FReOSSManage::FOSS::AsyncPutObjectMemoryByURL(
	const FString& URL, 
	const TArray<uint8>& Data, 
	const TMap<FString, FString>& OSSMeta, 
	ProgressCallback InProgressCallback)
...
void FReOSSManage::FOSS::AsyncResumableUploadObject(
	const FString &InBucketName, 
	const FString &InObjectName,
...
bool FReOSSManage::FOSS::UploadPart_Internal(
	void *in_pool,
...
bool FReOSSManage::FOSS::ListObjects_Internal(const FString &InBucketName, const FString &Delimiter, const FString &Prefix, TArray<FOSSObjectInfo> &ObjectName, int32 MaxNumber /*= 100*/)
{
	CREATE_CONFIGURATION_AND_STORAGE;
...
FString FReOSSManage::FOSS::AsyncUploadPart(
	const FString &InBucketName, 
	const FString &InObjectName, 
	const FString &InLocalPaths, 
	int32 PartSize /*= 1024 * 1024 * 10*/,
...
void FReOSSManage::FOSS::AsyncGetObjectToLocal(
	const FString &InBucketName,
	const FString &InObjectName, 
	const FString &InLocalPaths, 
	FRange Range /*= FRange()*/,
...
void FReOSSManage::FOSS::AsyncGetObjectToLocalByURL(
	const FString& URL, 
	const FString& InLocalPaths,
	FRange Range /*= FRange()*/,
	ProgressCallback InProgressCallback /*= nullptr*/,
...
void FReOSSManage::FOSS::AsyncGetObjectToMemory(
	const FString &InBucketName,
	const FString &InObjectName, 
	FRange Range /*= FRange()*/,
...
void FReOSSManage::FOSS::AsyncGetObjectToMemoryByURL(const FString& URL, FRange Range /*= FRange()*/, ProgressCallback InProgressCallback /*= nullptr*/, OnceStringCallBack InStartCallback /*= NULL*/, OnceStringCallBack InEndCallback /*= NULL*/)
{
	AsyncTask(ENamedThreads::AnyBackgroundThreadNormalTask,
...
void FReOSSManage::FOSS::AsyncGetObjectToMemoryByURL(
	const FString& URL, 
	FRange Range, 
	ProgressCallback InProgressCallback, 
	OnceStringCallBack InStartCallback, 
...
void FReOSSManage::FOSS::AsyncResumableDownloadObject(
	const FString &InBucketName, 
	const FString &InObjectName, 
	const FString &InDownloadFilePath, 
	int32 PartSize /*= 1024 * 1024 * 10,*/,
...
bool FReOSSManage::FOSS::PutObject(
	const FString &InBucketName, 
	const FString &InLocalPaths,
	const FString &InObjectName /*= FString()*/,
	ProgressCallback InProgressCallback /*= nullptr*/, 
...
bool FReOSSManage::FOSS::PutObjectByURL(const FString& URL, const FString& InLocalPaths, const TMap<FString, FString> &OSSMeta /*= TMap<FString, FString>()*/, ProgressCallback InProgressCallback /*= nullptr*/)
{
	FScopeLock ScopeLock(&Mutex);
...
bool FReOSSManage::FOSS::PutObjectByMemory(
	const FString &InBucketName,
	const FString &InObjectName /*= FString()*/,
	const FString &Data, 
	ProgressCallback InProgressCallback /*= nullptr*/, 
...
bool FReOSSManage::FOSS::PutObjectByMemory(const FString& InBucketName, const FString& InObjectName, const TArray<uint8>& InData, ProgressCallback InProgressCallback, const TMap<FString, FString>& OSSMeta)
{
	return PutObjectByMemory(InBucketName, InObjectName, InData.GetData(),InData.Num(), InProgressCallback, OSSMeta);;
}

bool FReOSSManage::FOSS::PutObjectByMemory(const FString& InBucketName, const FString& InObjectName,const void* InData, int32 InSize, ProgressCallback InProgressCallback, const TMap<FString, FString>& OSSMeta)
{
	STRING_TO_AOS_STRING_T(bucket, InBucketName);
	STRING_TO_AOS_STRING_T(object, InObjectName);
	CREATE_CONFIGURATION_AND_STORAGE;
...
bool FReOSSManage::FOSS::PutObjectMemoryByURL(
	const FString& URL,
	const FString &Data,
	const TMap<FString, FString> &OSSMeta /*= TMap<FString, FString>()*/,
	ProgressCallback InProgressCallback /*= nullptr*/)
...
bool FReOSSManage::FOSS::PutObjectMemoryByURL(const FString& URL, const TArray<uint8>& Data, const TMap<FString, FString>& OSSMeta, ProgressCallback InProgressCallback)
{
	return PutObjectMemoryByURL(URL, Data.GetData(), Data.Num(), OSSMeta, InProgressCallback);
}

bool FReOSSManage::FOSS::PutObjectMemoryByURL(const FString& URL, const void* Data, int32 DataSize, const TMap<FString, FString>& OSSMeta, ProgressCallback InProgressCallback)
{
	CREATE_CONFIGURATION_AND_STORAGE;
	STRING_TO_AOS_STRING_T(InUrl, URL);
...
//bool FReOSSManage::FOSS::AppendObject(const FString &InBucketName, const FString &InLocalPaths, const FString &InObjectName /*= FString()*/)
//{
//	FScopeLock ScopeLock(&Mutex);
//
//	const FString NewLocalPaths = NormalizePaths(InLocalPaths, InObjectName);
...
bool FReOSSManage::FOSS::ResumableUploadObject(
	const FString &InBucketName, 
	const FString &InObjectName,
	const FString &InUploadFilePath,
	int64 PartSize,
...
bool FReOSSManage::FOSS::UploadPart(
	FString &InUploadId, 
	const FString &InBucketName,
	const FString &InObjectName, 
	const FString &InLocalPaths,
...
bool FReOSSManage::FOSS::AbortMultipartUpload(const FString &InBucketName, const FString &InObjectName, const FString &InUploadId)
{
	CREATE_CONFIGURATION_AND_STORAGE;
...
//
//FString FReOSSManage::FOSS::GeneratePresignedUrl(const FString &InBucketName, const FString &InObjectName)
//{
//	ANSICHAR* bucket_name = TCHAR_TO_UTF8(*InBucketName);
...
//}
//
//void FReOSSManage::FOSS::AsyncGetObjectByUrl(const FString& InURL, const FString& InFilePaths, ProgressCallback InProgressCallback) const
//{
//	auto Lamada = [=]()
//	{
//		GetObjectByUrl(
...
//}
//
//void FReOSSManage::FOSS::AsyncPutObjectByUrl(const FString& InURL, const FString& InFilePaths, ProgressCallback InProgressCallback) const
//{
//	auto Lamada = [=]()
//	{
//		PutObjectByUrl(
...
//}
//
//bool FReOSSManage::FOSS::GetObjectByUrl(const FString& InURL, const FString& InFilePaths, ProgressCallback InProgressCallback) const
//{
...
//}
//
//bool FReOSSManage::FOSS::PutObjectByUrl(const FString& InURL, const FString& InFilePaths, ProgressCallback InProgressCallback) const
//{
//	ANSICHAR* URL = TCHAR_TO_UTF8(*InURL);
//	ANSICHAR* FilePaths = TCHAR_TO_UTF8(*InFilePaths);
//
...
bool FReOSSManage::FOSS::GetImageObjectByResize(const FVector2D &Size, const FString &InBucketName, const FString &InObjectName, const FString &InFileNametoSave)
{
...
bool FReOSSManage::FOSS::GetImageObjectByCrop(const FVector4 &Size, int32 Ratio, const FString &InBucketName, const FString &InObjectName, const FString &InFileNametoSave)
{
...
bool FReOSSManage::FOSS::GetImageObjectBySharpen(const int32 Sharpen, const FString &InBucketName, const FString &InObjectName, const FString &InFileNametoSave)
{
	FString Command = FString::Printf(TEXT("image/sharpen,%d"), Sharpen);
	return GetImageObject(InBucketName, InObjectName, InFileNametoSave, Command);
}

bool FReOSSManage::FOSS::GetImageObjectByWaterMark(const FString WaterMarkObjectName, const FString &InBucketName, const FString &InObjectName, const FString &InFileNametoSave)
{
	FString Command = FString::Printf(TEXT("image/watermark,%s"), *WaterMarkObjectName);
	return GetImageObject(InBucketName, InObjectName, InFileNametoSave, Command);
}

bool FReOSSManage::FOSS::GetImageObjectByRotate(const int32 Rotate, const FString &InBucketName, const FString &InObjectName, const FString &InFileNametoSave)
{
	FString Command = FString::Printf(TEXT("image/rotate,%i"), Rotate);
	return GetImageObject(InBucketName, InObjectName, InFileNametoSave, Command);
}

bool FReOSSManage::FOSS::GetImageObjectByStyle(const FString OSSStyleName, const FString &InBucketName, const FString &InObjectName, const FString &InFileNametoSave)
{
	FString Command = FString::Printf(TEXT("style/%s"), *OSSStyleName);
	return GetImageObject(InBucketName, InObjectName, InFileNametoSave, Command);
}

bool FReOSSManage::FOSS::GetImageObjectByCascade(const TArray<FString> &CascadeCommand, const FString &InBucketName, const FString &InObjectName, const FString &InFileNametoSave)
{
...
bool FReOSSManage::FOSS::GetImageInfo(const FString &InBucketName, const FString &InObjectName, const FString &InFileNametoSave)
{
