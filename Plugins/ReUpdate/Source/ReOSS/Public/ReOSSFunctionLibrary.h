...
#include "ReOSSType.h"
#include "ReOSSFunctionLibrary.generated.h"

UCLASS(meta = (BlueprintThreadSafe, ScriptName = "OSSLibrary"))
class REOSS_API UReOSSFunctionLibrary : public UObject
{
	GENERATED_BODY()

public:
	/*End Point*/
	UFUNCTION(BlueprintPure, Category = "ReOSS|InitOSS")
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "ReOSS|InitOSS")
	...
	*/
	UFUNCTION(BlueprintPure, Category = "ReOSS|Bucket")
	...
	* @ Acl				Jurisdiction
	*/
	UFUNCTION(BlueprintCallable, Category = "ReOSS|Bucket")
	...
	*/
	UFUNCTION(BlueprintPure, Category = "ReOSS|Objects")
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "ReOSS|Objects")
	...
	*/
	...
	/**
		...
		* @InObjectName	Object
		*/
	UFUNCTION(BlueprintCallable, Category = "ReOSS|URL")
	...
	* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
	*/
	UFUNCTION(BlueprintPure, Category = "ReOSS|Get")
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "ReOSS|Put")
	...
	* @ OSSMeta					OSS metadata can be customized or used. Please refer to oss_define.c for details
	*/
	UFUNCTION(BlueprintCallable, Category = "ReOSS|Put|Async") //Asynchronous upload can not get the real-time transmission of bytes, this is the Ali Cloud Library problem
	...
	* @ OSSMeta					OSS metadata can be customized or used. Please refer to oss_define.c for details
	*/
	UFUNCTION(BlueprintCallable, Category = "ReOSS|Put|Async")
	...
	* @ InProgressCallback		Callback is used for asynchrony. No callback is required for synchronization. This interface is for compatibility with asynchronous requests
	*/
	UFUNCTION(BlueprintCallable, Category = "ReOSS|Get|Async")
	...
	* @ bAllowEmptyRefere	Allow empty chain
	*/
	UFUNCTION(BlueprintPure, Category = "ReOSS|ImageProcessing")
