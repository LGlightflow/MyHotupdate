...
#define REOSS_MACRO_ERROR(Outcome) \
...
#define REOSS_MACRO_TYPE1(Request) \
REOSS_MACRO_META(Request) \
REOSS_MACRO_PROGRESSCALLBACK(Request)

#define REOSS_MACRO_META(Request) \
/*Set HTTP header*/  \
ObjectMetaData meta; \
{ \
...
#define REOSS_MACRO_PROGRESSCALLBACK(Request) \
...
{ \
	...
	UE_LOG(LogReOSS, Log, TEXT("%s"), *Msg); \
	CLEAR_WARN_COLOR(); \
}
...
{ \
	SET_WARN_COLOR(COLOR_CYAN); \
	const FString Msg = FString::Printf(TEXT(Format), ##__VA_ARGS__); \
	UE_LOG(LogReOSS, Log, TEXT("[DEBUG] %s"), *Msg); \
	CLEAR_WARN_COLOR(); \
}
...
{ \
	SET_WARN_COLOR(COLOR_CYAN); \
	const FString Msg = FString::Printf(TEXT(Format), ##__VA_ARGS__); \
	UE_LOG(LogReOSS, Log, TEXT("[SUCCESS] %s"), *Msg); \
	CLEAR_WARN_COLOR(); \
...
{ \
	...
	const FString Msg = FString::Printf(TEXT(Format), ##__VA_ARGS__); \
	UE_LOG(LogReOSS, Warning, TEXT("[WARNING] %s"), *Msg); \
	CLEAR_WARN_COLOR(); \
}
...
{ \
	...
	UE_LOG(LogReOSS, Warning, TEXT("%s"), *NewMsg); \
	CLEAR_WARN_COLOR(); \
...
{ \
	...
	const FString Msg = FString::Printf(TEXT(Format), ##__VA_ARGS__); \
	UE_LOG(LogReOSS, Error, TEXT("[ERROR] %s"), *Msg); \
	CLEAR_WARN_COLOR(); \
}
...
{ \
	...
	UE_LOG(LogReOSS, Error, TEXT("%s"), *NewMsg); \
	CLEAR_WARN_COLOR(); \
