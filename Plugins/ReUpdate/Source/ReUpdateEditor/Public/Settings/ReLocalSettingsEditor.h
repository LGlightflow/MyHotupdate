...
#include "ReLocalSettingsEditor.generated.h"

UCLASS(config = ReLocalSettingsEditor)	
class UReLocalSettingsEditor : public UObjectStorageSettings
{
	GENERATED_BODY()

public:
	UReLocalSettingsEditor();
